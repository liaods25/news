    ...
    <div class="container">
      ...
      <div class="crumbs">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item
            ><i class="el-icon-date"></i> 分类管理</el-breadcrumb-item
          >
      ...
      <div class="handle-box">
        ...
        >
          <el-form-item label="分类名称">
            <el-input v-model="query.cname" placeholder="分类名称"></el-input>
          </el-form-item>
          <!-- <el-form-item label="分类性别">
                <el-select v-model="select_cate" placeholder="分类性别">
      ...
      >
        ...
        <el-table-column prop="cid" label="分类ID"> </el-table-column>
        ...
        <el-table-column label="分类图标" width="180" align="center">
          <template slot-scope="scope">
            <el-image
              ...
              :src="$apiHost + scope.row.icon"
              :preview-src-list="[$apiHost + scope.row.icon]"
            >
            </el-image>
          </template>
        </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="分类图标">
          ...
          >
            <img v-if="form.icon" :src="$apiHost + form.icon" class="avatar" />
...
export default {
  ...
  methods: {
    ...
    handleEdit(row) {
      ...
      this.$axios
        .get(this.$api.category_detail + "/" + this.form.cid)
        .then((res) => {
          if (res.code == 200) {
            that.form = res.data;
    ...
    saveEdit() {
      ...
      if (this.form.cid) {
        this.$axios
          .put(this.$api.category_update, that.form)
          .then((res) => {
            if (res.code == 200) {
        ...
        this.$axios
          .post(this.$api.category_create, that.form)
          .then((res) => {
            if (res.code == 200) {
              that.$message.success(res.msg);
            } else {
    ...
    deleteRow() {
      var that = this;
      this.$axios
        .delete(this.$api.category_delete + "/" + this.form.cid)
        .then((res) => {
          if (res.code == 200) {
    ...
    handleIconSuccess(res, file) {
      this.form.icon = file.response.data.fileUrl;
    },
  },
};
</script>
